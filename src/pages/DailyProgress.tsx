                ...
                <div>
                   ...
                   <div className="space-y-3">
                     {distractionTiers.map(tier => {
                       ...
                       return (
                          <button key={tier} onClick={(e) => { (e.target as HTMLElement).blur(); setDistraction(tier); setStep(1); }}
                            className={`w-full text-right p-4 rounded-xl border transition-all focus:outline-none ${distraction === tier ? 'border-primary bg-primary/10' : 'border-border bg-card hover:border-primary/30'}`}>
                            <div className="flex items-center justify-center">
